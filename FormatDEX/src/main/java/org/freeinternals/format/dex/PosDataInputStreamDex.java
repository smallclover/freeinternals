...
public class PosDataInputStreamDex extends PosDataInputStream {
     ...
     * {@link Endian#ENDIAN_CONSTANT}, as the DEX format
     * specification said.
     */
    ...
    public PosDataInputStreamDex(PosByteArrayInputStream in, Endian e) {
        super(in);
        this.endian = e;
    }
    ...
    public Dex_short Dex_short() throws IOException {
        if (this.endian == Endian.ENDIAN_CONSTANT) {
    ...
    public Dex_uint Dex_uint() throws IOException {
        if (this.endian.value == Endian.ENDIAN_CONSTANT.value) {
     ...
     *
     * @throws IOException I/O Error
     * @throws FileFormatException Invalid LEB128
     * format
